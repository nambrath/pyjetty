...
OUTPUT_SUFFIX=$(echo $INPUT_FILE | cut -d/ -f14-16)
#echo $OUTPUT_SUFFIX
...
python process/user/anjali/process_data_ENC.py -c config/ENC/pPb/systematics/process_pPb_randomcone.yaml -f $INPUT_FILE -o $OUTPUT_DIR
